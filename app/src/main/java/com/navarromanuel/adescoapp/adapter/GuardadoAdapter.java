...
public class GuardadoAdapter extends FirebaseRecyclerAdapter<PojoInventario, GuardadoHolder> {
    ...
    protected void onBindViewHolder(GuardadoHolder saveViewHolder, final int position, PojoInventario pojoI) {
        ...
        saveViewHolder.procedencia.setText(pojoI.getProcedencia());
        ...
        saveViewHolder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final DialogPlus dialogPlus=DialogPlus.newDialog(saveViewHolder.producto.getContext())
                        .setContentHolder(new ViewHolder(R.layout.activity_fito_editar))
                ...
                final EditText procedencia=myview.findViewById(R.id.idProcedencia);
                ...
                procedencia.setText(pojoI.getProcedencia());
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        map.put("procedencia",procedencia.getText().toString());
                        map.put("fechaAlta",fechaAlta.getText().toString());

                        FirebaseDatabase.getInstance().getReference().child("ProductoFitosanitario").child(""+user.getUid()).child(getRef(position).getKey()).updateChildren(map)
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        FirebaseDatabase.getInstance().getReference().child("ProductoFitosanitario").child(""+user.getUid()).child(getRef(position).getKey()).removeValue();
                    }
                });
